...
var rentTiers = {
"SE_T013_002":"White Alone",
"SE_T013_003":"Black or African American Alone",
"SE_T013_004":"American Indian and Alaska Native Alone",
"SE_T013_005":"Asian Alone",
"SE_T013_006":"Native Hawaiian and Other Pacific Islander Alone",
"SE_T013_007":"Some Other Race Alone",
...
function dataDidLoad(error,data,blocks,boundary,water) {
    ...
    var chartSvg = d3.select("#charts")
    	...
    	.attr("width",width)
    	.attr("height",height)
    var colorScale = d3.scale.linear().domain([0,6]).range(["blue","orange"])
    var max = 100
    var colorIndex = 0
...
function calculateRent(blockgroups,column){
	...
	for(var i in blockgroups){
        ...
        var currentPopulation = parseFloat(blockgroup[1]["SE_T008_001"])
