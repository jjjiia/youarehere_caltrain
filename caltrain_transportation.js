...
var rentTiers = {
"SE_T128_002":"Means Of Transportation To Work For Workers 16 Years And Over: Car, truck, or van",
"SE_T128_003":"Means Of Transportation To Work For Workers 16 Years And Over: Public transportation (Includes Taxicab)",
"SE_T128_004":"Means Of Transportation To Work For Workers 16 Years And Over: Motorcycle",
"SE_T128_005":"Means Of Transportation To Work For Workers 16 Years And Over: Bicycle",
"SE_T128_006":"Means Of Transportation To Work For Workers 16 Years And Over: Walked",
"SE_T128_007":"Means Of Transportation To Work For Workers 16 Years And Over: Other means",
"SE_T128_008":"Means Of Transportation To Work For Workers 16 Years And Over: Worked at home",
"SE_T128_009":"Workers 16 Years and over: Car, truck, or van: Drove Alone",
"SE_T128_010":"Workers 16 Years and over: Car, truck, or van: Carpooled"
}
...
function dataDidLoad(error,data,blocks,boundary,water) {
    ...
    var chartSvg = d3.select("#charts")
    	...
    	.attr("width",width)
    	.attr("height",height)
    var colorScale = d3.scale.linear().domain([0,6]).range(["red","orange"])
    var max = 100
    var colorIndex = 0
...
function calculateRent(blockgroups,column){
	...
	for(var i in blockgroups){
        ...
        var currentPopulation = parseFloat(blockgroup[1]["SE_T128_001"])
	...
	for(var line in data.lines){
		...
		for (var station in stations){
			...
			for(var blockGroup in blockGroups){
				...
				var population = parseFloat(currentBlockGroup["SE_T008_001"])
