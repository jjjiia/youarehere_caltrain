...
function dataDidLoad(error,data,blocks,boundary,water) {
    ...
    var column = "SE_T128_003"

	drawLineGraph(initialLineToDraw,data,column,max,className)
	//drawAllBlocks(blocks,svg)
	addButton(initialLineToDraw,data,"Bike","SE_T128_005", max, "bike")
	addButton(initialLineToDraw,data,"Work From Home","SE_T128_008", max, "workFromHome")
	addButton(initialLineToDraw,data,"Public","SE_T128_003", max, "public")
	addButton(initialLineToDraw,data,"Walk","SE_T128_006", max, "walk")
	addButton(initialLineToDraw,data,"Car","SE_T128_002", max, "car")
	addButton(initialLineToDraw,data,"Population","SE_T001_001", 100, "population")
...
function formatLineData(lineColor,column,data){
	...
	for(var station in orderedStations){
		...
		var incomeData=calculateCommute(blockgroups,column)
